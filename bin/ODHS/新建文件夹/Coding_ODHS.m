...
%RC4加密
           ...
           [~,RC4_key_filepath]=FileIO.openResFileDialog('txt','RC4_key.txt');
            RC4_key=FileIO.readStrFile(RC4_key_filepath);
                 
[ secret_msg,data_header ] = RC4.codingByFile(char(msg),RC4_key,RC4_flag,ext_flag);
output_RC4dir_path=FileIO.openDirDialog('out','输出文件路径');
FileIO.generateStrFile([output_RC4dir_path,'\RC4_coding.txt'],secret_msg);
%转码
msg_bits=DC.str2BiUni( secret_msg);
